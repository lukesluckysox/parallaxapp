...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto flex items-center justify-around px-4 py-2.5">
        {NAV_ITEMS.map(({ href, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-[9px] font-mono ${isActive ? "text-foreground/70" : "text-muted-foreground/30"}`}>
                {label.toLowerCase()}
              </span>
            </Link>
          );
